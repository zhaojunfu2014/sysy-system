...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSysyEpController.do?doAdd" tiptype="1">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						  	 <textarea id="epContent" name="epContent"  style="width: 90%" class="inputxt" rows="6"></textarea>
							<span class="Validform_checktip"></span>
