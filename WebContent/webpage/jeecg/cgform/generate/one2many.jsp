...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="generateController.do?dogenerateOne2Many">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			<td align="right"><label class="Validform_label">代码包结构风格: </label></td>
			<td class="value"><select name="packageStyle">
				<option value="service">按业务模块划分</option>
				<option value="project">按技术模块划分</option>
			</select></td>
		</tr>
		<tr>
			<td align="right" width="20%"><label class="Validform_label"> 代码生成类型: </label></td>
		...
		<tr>
			<td align="right"><label class="Validform_label"> 功能描述: </label></td>
		...
		<tr>
			<td align="right"><label class="Validform_label"> 主表包名: </label></td>
